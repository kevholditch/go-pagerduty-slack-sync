...
- `@platform-everyone` => `user1, user2, user3` 
- `@platform` => `user3`
...
- `@platform-everyone` => combined list of all users in `abcd` and `efgh` schedules
- `@platform` => combined list of current on call users in `abcd` and `efgh` schedules
